...
public class Physician extends JFrame
{
    JComboBox comboBox;
    ...
    Physician()
    {
        ...
        JLabel labelHeading = new JLabel("Appointment Booking for Physician Department");
        ...
        try {
            Conn conn = new Conn();
            ResultSet resultSet = conn.statement.executeQuery("select * from Doctor where department = 'Physician'");
