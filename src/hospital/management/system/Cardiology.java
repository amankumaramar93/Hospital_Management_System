...
public class Cardiology extends JFrame
{
    ...
    Cardiology()
    {
        ...
        JLabel labelHeading = new JLabel("Appointment Booking for Cardiac Department");
        ...
        {
            Conn conn = new Conn();
            ResultSet resultSet = conn.statement.executeQuery("select * from Doctor where department = 'Cardiologist'");
