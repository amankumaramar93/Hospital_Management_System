...
public class Neurology extends JFrame
{
    ...
    Neurology()
    {
        ...
        JLabel labelHeading = new JLabel("Appointment Booking for Neurology Department");
        ...
        {
            Conn conn = new Conn();
            ResultSet resultSet = conn.statement.executeQuery("select * from Doctor where department = 'Neurology'");
